...
export declare enum FigmaEvent {
    /**
...
export type EventRegistry<TEvent> = {
    [K in keyof TEvent]: K extends string ? EventDefinition<K, SomeObject | undefined> : never;
};
export type FigmaEventRegistry = EventRegistry<FigmaEvent> & {
    [FigmaEvent.SelectionChanged]: FigmaEventDefinition<FigmaEvent.SelectionChanged, () => void>;
    [FigmaEvent.CurrentPageChanged]: FigmaEventDefinition<FigmaEvent.CurrentPageChanged, () => void>;
    [FigmaEvent.OnClose]: FigmaEventDefinition<FigmaEvent.OnClose, () => void>;
    [FigmaEvent.TimerStarted]: FigmaEventDefinition<FigmaEvent.TimerStarted, () => void>;
    [FigmaEvent.TimerPaused]: FigmaEventDefinition<FigmaEvent.TimerPaused, () => void>;
    [FigmaEvent.TimerStopped]: FigmaEventDefinition<FigmaEvent.TimerStopped, () => void>;
    [FigmaEvent.TimerDone]: FigmaEventDefinition<FigmaEvent.TimerDone, () => void>;
    [FigmaEvent.TimerResume]: FigmaEventDefinition<FigmaEvent.TimerResume, () => void>;
    [FigmaEvent.TimerAdjust]: FigmaEventDefinition<FigmaEvent.TimerAdjust, () => void>;
    ...
    [FigmaEvent.DocumentChanged]: FigmaEventDefinition<FigmaEvent.OnRun, DocumentChangeEvent>;
};
export type FigmaEventName = ArgFreeEventType | 'run' | 'drop' | 'documentchange';
export declare function isFigmaEvent(eventName: string): eventName is FigmaEventName;
